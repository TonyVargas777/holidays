// GetYourGuideLondonActivitiesWidget.jsx
import React, { useEffect, useRef } from "react";
import { useTranslation } from "react-i18next";

const GetYourGuideLondonActivitiesWidget = () => {
  ...
  useEffect(() => {
    ...
    if (widgetRef.current) {
      ...
      widget.setAttribute("data-gyg-q", "London");
...
export default GetYourGuideLondonActivitiesWidget;
