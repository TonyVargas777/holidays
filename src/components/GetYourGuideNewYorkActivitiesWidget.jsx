// GetYourGuideNewYorkActivitiesWidget.jsx
import React, { useEffect, useRef } from "react";
import { useTranslation } from "react-i18next";

const GetYourGuideNewYorkActivitiesWidget = () => {
  ...
  useEffect(() => {
    ...
    if (widgetRef.current) {
      ...
      widget.setAttribute("data-gyg-q", "new york");
...
export default GetYourGuideNewYorkActivitiesWidget;
